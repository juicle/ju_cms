...
class syController { 
	...
	{	
		if(TRUE == $GLOBALS['G_Ji']['view']['enabled']){
	...
	{
		if(TRUE == $GLOBALS['G_Ji']['view']['enabled'] && false !== $value){
	...
	{
		if( TRUE != $this->v->displayed && FALSE != $GLOBALS['G_Ji']['view']['auto_display']){
	...
	{
		if(in_array($name, $GLOBALS['G_Ji']["auto_load_controller"])){
