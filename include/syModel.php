...
class syModel {
	...
	{
		if( null == $this->tbl_name )$this->tbl_name = $GLOBALS['G_Ji']['db']['prefix'] . $this->table;
		if( '' == $GLOBALS['G_Ji']['db_driver_path'] ){
			$GLOBALS['G_Ji']['db_driver_path'] = $GLOBALS['G_Ji']['sp_drivers_path'].'/'.$GLOBALS['G_Ji']['db']['driver'].'.php';
		}
		$this->_db = syClass('db_'.$GLOBALS['G_Ji']['db']['driver'], array(0=>$GLOBALS['G_Ji']['db']), $GLOBALS['G_Ji']['db_driver_path']);
	}
	...
	{
		if(in_array($name, $GLOBALS['G_Ji']["auto_load_model"])){
