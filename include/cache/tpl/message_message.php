...
<form action="<?php echo $GLOBALS['WWW'] ?>index.php?c=message&a=add&tid=<?php echo $type['tid'] ?>" method="post" onsubmit="return postform();">
		...
		<dl><dt>标题：</dt><dd><input name="title" id="title" type="text" class="inp" style="width:300px;" /></dd><dd class="m"><?php echo $v['m'] ?></dd></dl>
		<dl><dt>内容：</dt><dd><script type="text/javascript">$(function(){KindEditor.create("#body",{resizeType : 1,allowPreviewEmoticons : false,allowImageUpload : false,items : ["fontname", "fontsize", "|", "forecolor", "hilitecolor", "bold", "italic", "underline","removeformat", "|", "justifyleft", "justifycenter", "justifyright", "insertorderedlist","insertunorderedlist", "|", "emoticons", "image", "link"]})});</script><textarea name="body" id="body" class="inp" style="width:550px; height:300px;"></textarea></dd><dd class="m"><?php echo $v['m'] ?></dd></dl>
