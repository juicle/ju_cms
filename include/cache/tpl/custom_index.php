...
<title>页面标题-<?php echo $GLOBALS['S']['title'] ?></title>
...
<div class="wpm list">
  ...
  <div class="tab1 tab1b main">
    <div class="l">
      <div class="columnc"><h2>栏目导航</h2></div>
      <div class="columncl">
      <?php $tn=0;$tablet=syClass("syModel")->findSql("select tid,molds,pid,classname,gourl,litpic,title,keywords,description,orders,mrank,htmldir,htmlfile,mshow from dy_classtype where  pid='0' and mshow='1' and pid=0  order by orders desc,tid");foreach($tablet as $t){ $t["tid_leafid"]=$sy_class_type->leafid($t["tid"]);$t["n"]=$tn=$tn+1; $t["classname"]=stripslashes($t["classname"]);$t["description"]=stripslashes($t["description"]); $t["url"]=html_url("classtype",$t); ?>
    ...
    <div class="r">
    <div class="content">
       <div class="position">当前位置：页面标题</div>
       <div class="c f2">自定义内容（可放任何静态内容，或loop，sql循环标签等）</div>
    </div>
    </div>
  </div>
