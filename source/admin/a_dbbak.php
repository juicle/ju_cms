...
class a_dbbak extends syController
{
	function __construct(){
		...
		$this->db=$GLOBALS['G_Ji']['db']['database'];
		$this->bakdir='include/backup/';
	}
	function index(){
		$p=$GLOBALS['G_Ji']['db']['prefix'];
		$pl=strlen($p);
		$dbs=array();$i=$ii=0;
	...
	function bak(){
		...
		echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><link href="source/admin/template/css/main_right.css" rel="stylesheet" type="text/css" />';
