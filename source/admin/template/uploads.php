...
function doyocms_upload_config(){
	...
	var bgimage='include/js/juupload/add.gif';
...
<?php if($fileover==1){
	...
	$(".info").empty();
	<?php } ?>
	$(".info").append('<li><p class="loading"><img src="include/js/juupload/loading.gif" /></p><p class="file"><span>'+date+'</span><br /><span class="progress"></span></p><p class="cancel"><a onclick="doyocms_upload_gocancel('+"'"+date+"'"+',1);"></a></p></li>');
<?php } ?>
};
...
.list li .cancel a{float:left; width:28px; height:25px; cursor:pointer; background:url(include/js/juupload/cancel.gif) no-repeat 0 5px;}
